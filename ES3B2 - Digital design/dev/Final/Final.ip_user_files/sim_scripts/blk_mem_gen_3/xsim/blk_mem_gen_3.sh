...
#
# Generated by Vivado on Mon May 01 23:04:25 +0100 2023
...
# Script info
echo -e "blk_mem_gen_3.sh - Script generated by export_simulation (Vivado v2019.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_3 xil_defaultlib.blk_mem_gen_3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_gen_3 -key {Behavioral:sim_3:Functional:blk_mem_gen_3} -tclbatch cmd.tcl -log simulate.log
}
